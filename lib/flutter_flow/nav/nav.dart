...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: MainSearchPageWidget.routeName,
          path: MainSearchPageWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'MainSearchPage')
              : NavBarPage(
                  initialPage: 'MainSearchPage',
                  page: MainSearchPageWidget(),
                ),
        ),
        FFRoute(
          name: AddNewVehiclePageWidget.routeName,
          path: AddNewVehiclePageWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'AddNewVehiclePage')
              : NavBarPage(
                  initialPage: 'AddNewVehiclePage',
                  page: AddNewVehiclePageWidget(),
                ),
        ),
        FFRoute(
        ...
        FFRoute(
          name: Auth4HomeWidget.routeName,
          path: Auth4HomeWidget.routePath,
          builder: (context, params) => Auth4HomeWidget(),
        )
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/Runno-Splashscreen.png',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
